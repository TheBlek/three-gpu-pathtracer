...
export const LEGO_MODELS = {

	'X-Wing': {
		opacityToTransmission: true,
		ior: 1.4,
		url: 'https://raw.githubusercontent.com/mrdoob/three.js/r150/examples/models/ldraw/officialLibrary/models/7140-1-X-wingFighter.mpd_Packed.mpd',
	},
...
modelNames.forEach( name => {
	...
	if ( ! ( cleanedName in LEGO_MODELS ) ) {

		LEGO_MODELS[ cleanedName ] = {
...
for ( const key in LEGO_MODELS ) {

	const info = LEGO_MODELS[ key ];
	if ( ! info.credit ) {

		info.credit = LDRAW_CREDIT;
